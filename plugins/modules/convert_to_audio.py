...
@pyrogram.Client.on_message(pyrogram.filters.command(["convertaudio"]))
    ...
    if (update.reply_to_message is not None) and (update.reply_to_message.media is not None) :
        ...
        if the_real_download_location is not None:
            a=await bot.edit_message_text(
                text=f"ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅ sᴜᴄᴄᴇssғᴜʟʟʏ, ɴᴏᴡ ᴛʀʏɪɴɢ ᴛᴏ ᴄᴏɴᴠᴇʀᴛ ɪɴᴛᴏ ᴀᴜᴅɪᴏ.\n\n⌛️ᴡᴀɪᴛ ғᴏʀ sᴏᴍᴇ ᴛɪᴍᴇ.",
                chat_id=update.chat.id,
        ...
        await bot.send_message(
            chat_id=update.chat.id,
            text=f"**ʀᴇᴘʟʏ** ᴡɪᴛʜ ᴀ ᴛᴇʟᴇɢʀᴀᴍ ᴠɪᴅᴇᴏ ғɪʟᴇ ᴛᴏ ᴄᴏɴᴠᴇʀᴛ.",
            reply_to_message_id=update.message_id
        )
