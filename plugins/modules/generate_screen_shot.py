...
@pyrogram.Client.on_message(pyrogram.filters.command(["screenshot"]))
async def generate_screen_shot(bot, update):
    ...
    if update.reply_to_message is not None:
        ...
        if the_real_download_location is None:
            ...
            await bot.edit_message_text(
                text=f"ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ.\nɴᴏᴡ ɢᴇɴᴇʀᴀᴛɪɴɢ sᴄʀᴇᴇɴsʜᴏᴛs📸.",
                chat_id=update.chat.id,
                message_id=a.message_id
            )
            ...
            if images is not None:
                i = 0
                caption = "**sᴄʀᴇᴇɴsʜᴏᴛ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ**: @Htgtoolv4bot\n**ᴍʏ ᴄʜᴀɴɴᴇʟ:** @Tg_Galaxy"
                for image in images:
