...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('😉 Hello', url='https://t.me/Htgtoolv4bot')],[InlineKeyboardButton('List All Types of Quote Categories', callback_data='qtstags')]])

@Client.on_message(filters.command("quot"))
