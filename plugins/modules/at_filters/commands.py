...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('ℹ️ Start', url=f"https://t.me/Htgtoolv4bot?start=start"),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("➕ᴀᴅᴅ ᴍᴇ ᴛᴏ ᴄʜᴀᴛ!", url="http://t.me/Htgtoolv4bot?startgroup=botstart"),
    ...
    if len(message.command) ==2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("⚙️ sᴇᴛᴛɪɴɢs", callback_data="modules"),
            InlineKeyboardButton("🤖 ᴍʏ ʙᴏᴛ's", callback_data="mybots")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
