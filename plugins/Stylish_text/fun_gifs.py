...
@Client.on_message(filters.command("happy"))
...
@Client.on_message(filters.command("poke"))
...
@Client.on_message(filters.command("tickle"))
...
@Client.on_message(filters.command("baka"))
...
@Client.on_message(filters.command("facepalm"))
...
@Client.on_message(filters.command("crying"))
...
@Client.on_message(filters.command("kitsune"))
...
@Client.on_message(filters.command("sleep"))
def sleep(_, message):
